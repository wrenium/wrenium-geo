...
/// @p workspace.svgPath -- projectRings() (cylindrical_pipeline.h)
/// followed by emitSvgPath() (svg_emitter.h), in one call.
...
// NOLINTEND(bugprone-easily-swappable-parameters)
{
    ...
    return emitSvgPath(workspace.projectedPoints(), workspace.projectedRingSizes().data(), workspace.projectedRingSizes().size(), workspace.svgPath);
}

/// Projects @p input's open runs and writes the result as SVG path text
/// into @p workspace.svgPath -- projectLines() (cylindrical_pipeline.h)
/// followed by emitSvgLinePath() (svg_emitter.h), in one call.
...
// NOLINTEND(bugprone-easily-swappable-parameters)
{
    ...
    return emitSvgLinePath(workspace.projectedPoints(), workspace.projectedRingSizes().data(), workspace.projectedRingSizes().size(), workspace.svgPath);
}
