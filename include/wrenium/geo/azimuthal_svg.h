...
/// @p workspace.svgPath -- projectRings() (azimuthal_pipeline.h) followed
/// by emitSvgPath() (svg_emitter.h), in one call.
...
/// into @p workspace.svgPath -- projectLines() (azimuthal_pipeline.h)
